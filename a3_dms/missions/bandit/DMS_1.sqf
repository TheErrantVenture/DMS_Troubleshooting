...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION DMS_1.sqf with invalid parameters: %1",_this];
};
...
switch (_difficulty) do
{
	case "easy":
	{
		...
		_vehicle = ["OPTRE_m1087_stallion_unsc_repair",[(_pos select 0) -46.366,10.4241,(_pos select 1) -4.76837e-007],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	};
...
_group =
[
	[_pos,[-24.522,20.5319,3.04116]] call DMS_fnc_CalcPos,
	[_pos,[-42.5804,44.3248,3.0351]] call DMS_fnc_CalcPos,
	[_pos,[27.596,35.303,3.02928]] call DMS_fnc_CalcPos,
	_AICount,
	"hardcore",
	"random",
	_side
...
[
	...
	[_pos,[-22.1558,1.7053,22.8731],179.063] call DMS_fnc_CalcPos,
	[_pos,[-10.5926,1.68877,22.873],179.063] call DMS_fnc_CalcPos,
	[_pos,[54.3123,0.239208,0],89.7081] call DMS_fnc_CalcPos,
	[_pos,[53.7149,19.6848,0],90.9358] call DMS_fnc_CalcPos
	],
	_group,
	"assault",
	"hardcore",
...
_msgLOSE = ['#FF0000',"The bugs control the facility!"];

// Define mission name (for map marker and logging)
_missionName = "Federation Research Facility";
