...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION DMS_2.sqf with invalid parameters: %1",_this];
};
...
switch (_difficulty) do
{
	case "easy":
	{
		_msgStart = ['#FFFF00',format ["A Federation Data Facility is under attack by bugs at %1!  Secure the facility!",mapGridPosition _pos]];
		...
		_vehicle = ["OPTRE_UNSC_falcon_armed_S",[(_pos select 0) 12.2458,(_pos select 1) -18.9372],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	};
...
_group =
[
	[_pos,[-15.4897,-64.6613,15.6819]] call DMS_fnc_CalcPos,
	[_pos,[-14.1078,-61.5951,10.0295]] call DMS_fnc_CalcPos,
	[_pos,[-13.6089,-62.1989,0]] call DMS_fnc_CalcPos,
	_AICount,
	"hardcore",
	"random",
	_side
